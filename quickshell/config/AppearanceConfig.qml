...
QtObject {
    ...
    readonly property var anim: QtObject {
        // Every top-level panel uses these values: one place to tune shell motion.
        readonly property var popup: QtObject {
            property int duration: 90
            property int fadeDuration: 70
            property real closedScale: 0.98
            property int offset: 12
            property var curve: [0.05, 0.7, 0.1, 1.0]
        }
